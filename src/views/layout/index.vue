  ...
  <div>
    ...
    <div class="mobile-layout">
        <div class="mobile-layout-header">
          <img class="logo" @click="openLogo" src="@/assets/images/home/home_logo.png" alt="" />
          <div class="searh">
              <input type="text" class="input-set" v-model="input" placeholder="搜索NFT">
  ...
  data () {
    return {
      ...
      routerList: [
        ...
        {
          //name: '项目介绍',
          name:this.$t('Projectintro.title'),
        ...
        // },
        {
          name:this.$t('myCommunities.title'),
          path: '/myCommunities',
          icon: require('../../assets/images/nav/projectInfo.png')
        },
        {
          // name: '基金会',
          name:this.$t('foundation.title'),
          path: '/foundation',
