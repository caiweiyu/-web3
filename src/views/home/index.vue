<template>
  <div>
    ...
    <div class="mobile-home">
      <div class="bg">
          <slider-show :slides="slides2" :inv="invTime" class="slider-show"/>
          <!-- <div class="bg-title">
        ...
        <div class="nft">
          ...
          <ul class="hot-content">
            <div class="hot-content-text">{{$tc(`header.gold`)}}</div>
            <div class="hot-content-btn">{{$tc(`header.search`)}}
              <i class="el-icon-arrow-right"></i>
            </div>
            <div class="hot-content-img" @click="nftMarket"></div>
        ...
        <div class="nft nft-action">
          ...
          <div class="nft-action-img"  @click="buyDetail2">
              <div class="nft-action-img-text">{{$tc(`header.gold`)}}</div>
              <div class="nft-action-img-btn">{{$tc(`header.search`)}}
                <i class="el-icon-arrow-right"></i>
              </div>
          </div>
          ...
          <!--底部-->
          <div class="foot">
            <div class="foot-title">{{ $tc('home.followus')}}</div>
            <ul class="foot-imgs">
              <a :href="item.name" v-for="(item,index) in links" :key="index">
                <img :src="item.img" alt="">
              </a>
            </ul>
            <div class="foot-title">{{ $tc('home.resource')}}</div>
            <ul class="foot-imgs">
              <li>{{ $tc('home.authorCertification')}}</li>
              <li>{{ $tc('home.Developmentfile')}}</li>
              <li>{{ $tc('home.whitebook')}}</li>
            </ul>
            <div class="foot-title1">©2023 Wand All Rights Reserved</div>
          </div>
          <div class="foot-bottom">
            <div class="foot-bottom-tip" @click="goPost">
              <div class="foot-bottom-tip-img"></div>
              <div class="foot-bottom-tip-div">{{ $tc('home.overhead')}}</div>
            </div>
          </div>
    </div>
  </div>
...
export default {
  data() {
    return {
      ...
      slides: [
        {
          src: require('../../assets/images/home/uuu.png'),
          title: 'wand黄金宫廷艺术品',
          // href: '/Privateplacement'
        },
        {
          src: require('../../assets/images/home/yy.png'),
          title: 'wand黄金宫廷艺术品NFT',
          // href: '/Privateplacement'
        }
      ],
      slides2: [
      ...
      arr:[
        {name:this.$tc('home.pureGold'),img:require("../../assets/images/home/mobile/44.png")},
        {name:this.$tc('home.lottery'),img:require("../../assets/images/home/mobile/11.png")},
        {name:this.$tc('home.kGold'),img:require("../../assets/images/home/mobile/33.png")},
        {name:this.$tc('home.other'),img:require("../../assets/images/home/mobile/22.png")},
      ],
      glodlist:[
      ...
      status:false,
      links:[
        {img:require('../../assets/images/home/f1.png'),name:"https://www.twitter.com/"},
        {img:require('../../assets/images/home/f2.png'),name:"https://www.facebook.com/"},
        {img:require('../../assets/images/home/f3.png'),name:"http://www.instagram.com/"},
      ]
    };
  },
  created() {
...
@media screen and (max-width:780px){
  ...
  .nft{ 
    ...
    .hot-content{
      ...
      position:relative;
      &-img{
        width:pxttrem(630.9090909090909);//pxttrem(694);//;
        height: pxttrem(247.27272727272725);//;pxttrem(272);//;
        background: url('../../assets/images/home/nft_active.png') center no-repeat;
        background-size:100% 100%;
      }
      &-text{
        position: absolute;
  ...
  .nft-action{
    ...
    &-img{
        ...
        // width:pxttrem(630.9090909090909);//pxttrem(694);//;
        height: pxttrem(247.27272727272725);//;pxttrem(272);//;
        background: url('../../assets/images/home/nft_auction.png') center no-repeat;
        background-size:100% 100%;
        position: relative;
        &-text{
          position: absolute;
  ...
  .swiper-container {
    ...
    .foot{
      width: 100vw;
      min-height: pxttrem(458);
      background: rgba(216, 190, 122, 1);
      margin: pxttrem(34) auto 0;
      color:rgba(51, 51, 51, 1);
      font-size: pxttrem(28);
      &-title{
        padding-top: pxttrem(34);
        margin: auto;
        text-align: center;
      }
      &-imgs{
    ...
    .foot-bottom{
      ...
      &-tip{
        ...
        &-img{
          width: pxttrem(21);
          height: pxttrem(11);
          background: url('../../assets/images/home/top.png')center no-repeat;
          background-size:100% 100%;
          margin: pxttrem(20) auto 0;
        }
        &-div{
